...
namespace
{
    ...
    TEST_F(SurfaceNifMaterialTest, shouldDescribeASurfaceFromItsProperties)
    {
    ...
    /// default.
    TEST_F(SurfaceNifMaterialTest, aSurfaceShowsOneFaceUnlessAStencilPropertyDrawsBoth)
    {
    ...
    TEST_F(SurfaceNifMaterialTest, shouldDescribeABlendedSurfaceAsBlendedAndKeepItsThreshold)
    {
        Nif::NiAlphaProperty alpha;
        init(static_cast<Nif::NiObjectNET&>(alpha));
        alpha.mRecordType = Nif::RC_NiAlphaProperty;
