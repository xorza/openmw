...
namespace Sky
{
    namespace
    {
        ...
        TEST(RtxSkyRollTest, theDeckScrollsAtTheWeathersSpeedAndOnTheClockTheContentNames)
        {
            ...
            SkyRoll scaled(true);
            scaled.advance(1.0f, 1.25f, 30.0f);
            ...
            SkyRoll windless(true);
            windless.advance(600.0f, 0.0f, 30.0f);
        ...
        {
            SkyRoll stepped(true);
            for (int frame = 0; frame < 600; ++frame)
                stepped.advance(1.0f / 60.0f, 1.25f, 30.0f);
