...
namespace MWRender
{
    ...
    TracedGround::~TracedGround() = default;
    ...
    TracedGround::CellGrid TracedGround::takeGrid()
    {
        if (!mSpare.empty())
        {
    ...
    void TracedGround::loadCell(const int x, const int y)
    {
    ...
    void TracedGround::unloadCell(const int x, const int y)
    {
