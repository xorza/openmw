...
// The record for the water, which shades by tracing twice more, and nothing more.
// `visibility.rmiss` says why a record that is never invoked has to exist at all.
//
